...
reference_seed_page = "https://www.geeksforgeeks.org/fundamentals-of-algorithms/#AnalysisofAlgorithms"     #Defining the seed URL (should be with a prefix, netloc and scheme and without path)
